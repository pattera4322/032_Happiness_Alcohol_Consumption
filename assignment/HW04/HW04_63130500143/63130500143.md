...
```
จากตัวอย่างจะเห็นได้ว่าเป็นการเลือกดูเเค่หัวข้อ column ที่เราสนใจ โดยในตัวอย่างเราสนใจ column Product.ID, Sales และ Country ข้อมูลก็จะปรากฏออกมาอย่างที่เห็น เเต่เนื่องจากข้อมูลในตารางนั้นมีจำนวนมาก เราจึงใช้ `as_tibble()` เข้ามาช่วยเพื่อให้เเสดงข้อมูลในตารางน้อยลงนั่นเอง
