...
ตัวอย่างถ้าเราอยาก filter หาว่ามีลูกค้าคนไหนบ้างที่ซื้อ furniture ราคามากกว่า 500 เราสามารถ filter category ให้เป็น furniture และ sale ให้มีค่ามากกว่า 500 ซึ่งคั่นด้วยเครื่องหมาย `,` ซึ่งึวามหมายของมันคือ 'เเละ' นั่นเอง 
```
superstore <- as_tibble(superstore)
